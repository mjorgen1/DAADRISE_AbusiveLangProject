...
train.to_csv("ArabicCleanedTrainingData.csv", index=None, header=True, encoding='utf-8-sig')
test.to_csv("ArabicCleanedTestingData.csv", index=None, header=True, encoding='utf-8-sig')